package net.pixeldream.valormobs.goal;
...
public class ExecutionerAttackGoal extends Goal {
    ...
    public ExecutionerAttackGoal(PathAwareEntity mob, double speed, boolean pauseWhenMobIdle) {
        this.mob = mob;
        this.speed = speed;
