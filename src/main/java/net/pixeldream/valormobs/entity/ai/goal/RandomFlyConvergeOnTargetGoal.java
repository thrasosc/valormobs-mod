package net.pixeldream.valormobs.entity.ai.goal;
...
public class RandomFlyConvergeOnTargetGoal extends Goal {
    private final ValorEntity parentEntity;

    /**
     * @param valorEntity Entity that is flying
     */
    public RandomFlyConvergeOnTargetGoal(ValorEntity valorEntity) {
        this.parentEntity = valorEntity;
