...
public class SphinxEntity extends HardEnemy {
    public SphinxEntity(EntityType<? extends Monster> entityType, Level level) {
    ...
    public BrainActivityGroup<ValorEntity> getFightTasks() {
        return BrainActivityGroup.fightTasks(
                ...
                new SetWalkTargetToAttackTarget<>().speedMod((owner, target) -> 0.4f),
                new CustomMeleeAttack<>(15));
    }

    @Override
    public double getMeleeAttackRangeSqr(LivingEntity entity) {
        return this.getBbWidth() * 1.5F * this.getBbWidth() * 1.5F + this.getBbWidth();
    }
